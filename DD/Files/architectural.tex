...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Creation of events regarding tournaments and battles.
        \item Management of the ranking of the students.
        \item Management of data related to tournaments, battles, teams and submissions.
...
The methods offered by the DBMSs, instead, are kept generic since they are a representation of the queries that can be performed on the databases, which will be implemented using the most appropriate technology.
