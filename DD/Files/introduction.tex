...
\begin{itemize}
    \item \textbf{Section 1: Introduction}\\ In this section a general description of the document and the system to be developed is provided. It's also included a glossary of terms used in the document and a list of reference documents.
