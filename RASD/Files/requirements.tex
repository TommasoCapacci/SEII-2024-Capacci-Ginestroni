...
\begin{enumerate}[label=\textbf{F\arabic*)}]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{Mockups/9_student_tournament_subscription.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{Mockups/10_educator_create_battle.png}
