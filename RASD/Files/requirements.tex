...
\end{figure}
The figure \ref{fig:student_homepage} shows the home page of the CKB website as it appears to a student. It contains different information depending on the user's role. In particular, the student can see the list of all tournaments and battles he is participating in and a calendar showing upcoming deadlines.
...
The tournament page allows the users to visualize the personal rank of students participating in it. The figure \ref{fig:leaderboard} shows in particular how the leaderboard will be displayed to an educator.
\begin{figure}[H]
    \centering
...
Also educators can access the same page to review the code and assign a manual score to the team.
\newpage
