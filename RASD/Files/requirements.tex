...
\begin{center}
    ...
    \begin{tabular}{ |c|m{10cm}| }
        ...
        \textbf{Entry conditions} &
        \begin{itemize}
            \item A new commit is pushed into some team’s GitHub repository
        ...
        \begin{enumerate}
            ...
            \item System computes a score for timeliness by comparing the timestamp of the POST request with the one corresponding to the start of the submission phase of the battle
