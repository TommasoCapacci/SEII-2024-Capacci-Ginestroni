...
all s:Student, to:Tournament, b:Battle | (#to.participants[s] = 1 and (to.state = Subscription or (b in to.battles and b.state != Finished) ) ) 
        implies 
    #to.participants[s] = 0
}
...
\begin{figure}[H]
    \centering
    \hspace{-4cm}\includegraphics[width=1.3\textwidth]{Alloy/world1.png}
    \caption{World1}
\end{figure}
\begin{figure}[H]
    \centering
    \vspace{-3cm}\includegraphics[width=1.8\textwidth,angle=90,origin=c]{Alloy/world2.png}
    \caption{World1}
\end{figure}